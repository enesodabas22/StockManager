...
FIREBASE_KEY_PATH = os.path.join(basedir, "firebase_key.json")
    ...
    def kullanim_kilavuzu_ac(self):
        ...
        steps = [
            ...
            },
            {
                ...
                'widget': self.dashboard_sayfasi.findChild(QWidget, "metricCard"), # İlk kartı bulmaya çalışır (Toplam Stok)
                'page_index': 0
            },
            {
